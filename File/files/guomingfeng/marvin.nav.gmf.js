...
a.ready(function () {
    ...
    if (o.length > p) {
        ...
        if (t.length + u.length + v.length > p) {
            r = false;
        }
    };
    o.each(function (t) {
        ...
        if (v.localName === 'h1') {
            ...
            if (q) {
                ...
                j += '<li class="h2Offset"><span>' + l + '.' + m + '&nbsp&nbsp</span><a href="#' + u.attr('id') + '" title="' + title + '">' + text + '</a><span class="sideCatalog-dot"></li>';
            }
        } else if (v.localName === 'h3') {
            n++;
            if (r) {
                if (text.length > 10) text = text.substr(0, 8) + "...";
                j += '<li class="h3Offset"><span>' + l + '.' + m + '.' + n + '&nbsp&nbsp</span><a href="#' + u.attr('id') + '" title="' + title + '">' + text + '</a><span class="sideCatalog-dot"></li>';
            }
        }
    });
    $('#' + f + '>ul').html(j);
