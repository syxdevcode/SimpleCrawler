...
$(function () {    
    (function ($) {
        $.fn.jalendar = function (options) {
            ...
            dayNames['TR'] = new Array('周一', '周二', '周三', '周四', '周五', '周六', '周日');
            dayNames['ES'] = new Array('周一', '周二', '周三', '周四', '周五', '周六', '周日');
            ...
            for (var i=0;i<59;i+=5 ){
                clockMin.push(div('div', 'today').text(i))
            }
            ...
            function calcMonth() {
                ...
                if ( month == d.getMonth() ) {
                    $this.find('.day.this-month').removeClass('today').eq(date-1).addClass('today').css('color', settings.color).css("background-color","rgb(45, 161, 45)").css("color","#fff");
                } else {
